...
<head>
  ...
  <style>
    ...
    .birthday-box {
      ...
      color: black;
      padding: 5px 10pxborder-radius: 5px;
      z-index: 999;
    } 
  </style>
</head>
...
<body> </div> <div class="containor">
    ...
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-sp 𒌍•⸺̥̊ 𒋲 〲⭕ 𝐅𝐅𝐈𝐂𝐈𝐀𝐋 𓆩𖤓𓆪 ❍Ꮗɳɘr᩶ Noddy 🔥𒋲 ㅤ𖤓ㅤ࿐ㅤ࿐. 🥱🥱</span>.</span></p>
      <p><span class="boxed-text2"><span class="color-span">Noddy</span></span></p>
  </p>
    </footer>
    </div>
</div>
...
<body>
  <div>
    ...
    <!-- Your text box content here -->
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa">𝑴𝑨𝑫𝑬 𝑩𝒀 Noddy</span>.</span></p>
